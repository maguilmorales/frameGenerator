...
const range = (start, end, step = 1) => {
  ...
  const Frame2 = () => {
    ...
    return (
      <>
        <mesh ref={mesh} position={[1, 7, 0]}> 
        {/* <primitive object={[RoundedRect()]}/> */}
        <shapeGeometry args={[RoundedRect2()]}/>
          <shaderMaterial
            key={uuidv4()}
            vertexShader={`
              varying vec3 worldNormal;
  ...
  const Frame3 = () => {
    ...
    return (
      <>
        <mesh ref={mesh} position={[9.7, 0, 0.5]}> 
        {/* <primitive object={[RoundedRect()]}/> */}
        <boxGeometry args={[8,11,0.2]}/>
          <shaderMaterial
            key={uuidv4()}
            vertexShader={`
              varying vec3 worldNormal;
...
void main(){
  ...
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position,1.0);
            ...
            void main() {
              ...
              vec2 uv = vUv;
              vec4 color = texture2D(uTexture3, uv);
